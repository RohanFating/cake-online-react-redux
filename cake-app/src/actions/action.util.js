...
export default class AppActionUtil {
    ...
    static getCakeInfo() {
        return function (dispatch) {
            return cakeService.getCakeList().then((data) => {
     ...
     */
    static clearCakeDetailsData(data) {
        return { type: AppConstants.RESET_DETAILS_DATA, data: data };
    }
    ...
    static updateFormData(formData) {
            ...
            return { type: AppConstants.CAKE_FORM_DATA, data: formData };
    }

    /**
     * To submit cake from user
     */
    static submitCakeAction(cakeDetail) {
        return function (dispatch) {
